      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <Brain size={20} style={{ color: 'var(--xp-chart-palette-2)' }} />
            <span style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{
                ...
                AI-Powered Primary & Secondary Product Expansion
              </p>
            </div>
            <div style={{
              display: 'flex',
              ...
              <div style={{
                ...
                <Brain size={16} style={{ color: 'var(--xp-chart-palette-2)' }} />
                <span style={{
                  fontSize: 'var(--xp-text-sm)',
                  fontWeight: 'var(--xp-font-weight-medium)',
                  color: 'var(--xp-chart-palette-2)'
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  onFocus={(e) => {
                    e.target.style.outline = `var(--xp-focus-ring-width) solid var(--xp-focus-ring)`;
                    e.target.style.outlineOffset = 'var(--xp-focus-ring-offset)';
                  }}
                  onBlur={(e) => {
            ...
            {activeTab !== 'overview' && (
              <div style={{
                ...
                <div style={{
                  ...
                  <Rocket size={32} style={{ color: 'var(--xp-text-tertiary)' }} />
                </div>
                <h3 style={{
                ...
                <p style={{
                  ...
                  Advanced {activeTab.replace('_', ' ')} analytics and insights will be available here.
                </p>
              </div>
            )}
          </div>
